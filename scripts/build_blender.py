...
corrections=bpy.data.texts.new('Reviewed terrain corrections.json');corrections.from_string((D/'terrain-corrections.json').read_text())
readme.write('\nTERRAIN CORRECTION 12 September 2026: two isolated Mapzen source artefacts replaced with GA DEM water-surface values. Original samples and source responses are embedded in Reviewed terrain corrections.json. Zero does not represent measured seabed depth.\n')
scene.frame_set(1)
