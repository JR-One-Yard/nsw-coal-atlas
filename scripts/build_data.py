...
configs=[('Dendrobium','dendrobium',['met'],['wongawilli'],'Underground · Wongawilli','Metallurgical coal; preparation and steelmaking/export connections at Port Kembla.',['dendrobium','southern','southtransport']),('Appin','appin',['met'],['bulli'],'Underground · Bulli','Bulli Seam coal, processed through associated facilities including West Cliff.',['appin','southtransport']),('Metropolitan','metropolitan',['met'],['bulli'],'Underground · Bulli','Coking coal exported through Port Kembla.',['metro','southern']),('Mandalong','mandalong',['thermal'],[],'Underground','Supplies Eraring and Vales Point power stations.',['mandalong']),('Myuna','myuna',['thermal'],['wallarah','greatnorthern','fassifern'],'Underground · three seams','Power-station coal from beneath the Lake Macquarie area; supply to Eraring.',['myuna','myunaproduct']),('Mount Thorley','mtw',['thermal','met'],['hunter'],'Open cut · multiple seams','Thermal and semi-soft coking coal.',['mtw','port'])]
extra=[
 ...
 ('Bloomfield','bloomfield',['thermal'],[],'Open cut','Thermal coal from multiple seams.','https://www.bloomcoll.com.au/operations/bloomfield-collieries'),
 ...
 ('Chain Valley','chainvalley',['thermal'],[],'Underground','Developed to supply Vales Point power station.','https://www.deltacoal.com.au/ArticleDocuments/10302/Delta%20Coal%20Fact%20Sheet%2010%20Jan%202023.pdf.aspx'),
 ...
 ('United Wambo','unitedwambo',['thermal','met'],['hunter'],'Open cut','The 2024 review reports thermal and metallurgical coal. Registry name: proposal.','https://www.glencore.com.au/.rest/api/v1/documents/7b5888d56616d0ea4df620724dfd6658/2024_DEV_UW_EXT_AREP_Review_App.pdf')]
